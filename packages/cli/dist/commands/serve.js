...
var local_api_1 = require("@ts-notebook/local-api");
            ...
            switch (_a.label) {
                ...
                case 2:
                    ...
                    if ((error_1.code = 'EADDRINUSE')) {
                        console.error('Serve failed: port is already in use. Use a different port by adding the "-p <number>" flag to the serve command');
                    }
                    else {
                        console.error('Serve failed:', error_1.message);
                    }
                    return [3 /*break*/, 3];
